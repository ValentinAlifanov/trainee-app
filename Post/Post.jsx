...
export default function MyArticlesPost ({ item }) {
    return (
        <div className='Post-box'>
            <div>
                <img className='Post-Photo' src={item.PostPhoto} alt="MyArticlesPost"/>
            </div>
            <article className='Post-read-box'>
                ...
                <div className='Post-info-box'>
                    <div className='Post-info-box__user-avatar-box'>
                        <img className='Post-info-box__user-avatar' src={item.userAvatar} alt="user-avatar-MyArticlesPost"/>
                    </div>
